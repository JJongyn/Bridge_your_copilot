...
class BridgeClient:
    ...
    def _request(
        ...
        try:
            ...
            raise BridgeError(f"Connection error: {exc.reason}") from exc
...
BridgeYourCopilotError = BridgeError
BridgeYourCopilotClient = BridgeClient
CopilotError = BridgeError
CopilotClient = BridgeClient
CopilotBridgeError = BridgeError
CopilotBridgeClient = BridgeClient
